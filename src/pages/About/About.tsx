...
const EnContent = () => (
  <div className="about-content">
    <h1>About Us</h1>
    <img src="/assets/ann_2.png" alt="About Us" style={{ width: '100%', maxWidth: '800px', height: 'auto', marginBottom: '30px', borderRadius: '8px', display: 'block' }} />
    ...
    <img src="/assets/ann_1.png" alt="Company Growth" style={{ width: '100%', maxWidth: '800px', height: 'auto', margin: '30px 0', borderRadius: '8px', display: 'block' }} />
...
const ZhContent = () => (
  <div className="about-content">
    <h1>公司簡介</h1>
    <img src="/assets/ann_2.png" alt="公司簡介" style={{ width: '100%', maxWidth: '800px', height: 'auto', marginBottom: '30px', borderRadius: '8px', display: 'block' }} />
    ...
    <img src="/assets/ann_1.png" alt="團隊成長" style={{ width: '100%', maxWidth: '800px', height: 'auto', margin: '30px 0', borderRadius: '8px', display: 'block' }} />
